...
(yas-define-snippets 'haskell-mode
                     '(("case" "case ${1:x} of\n    ${2:Data} -> ${4:undefined}\n    ${3:Data} -> ${5:undefined}$0" "case" nil nil
                       ...
                       ("data" "data ${1:Type} = $1\n    { ${2:field} :: ${3:Type}\n    , ${4:field} :: ${5:Type}$0\n    } ${6:deriving (${7:Show, Eq})}" "record data"
                        (=
                         ...
                         (current-column))
                        nil nil nil nil nil)
                       ("fn" "${1:f} :: ${2:a} ${3:-> ${4:b}}\n$1 ${5:x} = ${6:undefined}$0" "simple function"
                        (=
                         (length "fn")
                         (current-column))
                        nil
                        ((yas-indent-line 'fixed))
                        nil nil nil)
                       ("fn" "${1:f} :: ${2:a} ${3:-> ${4:b}}\n$1 ${5:pattern} = ${7:undefined}\n$1 ${6:pattern} = ${8:undefined}$0" "clause function"
                        (=
                         (length "fn")
                         (current-column))
                        nil
                        ((yas-indent-line 'fixed))
                        nil nil nil)
                       ("fn" "${1:f} :: ${2:a} ${3:-> ${4:b}}\n$1 ${5:x}\n    | ${6:conditional} = ${8:undefined}\n    | ${7:conditional} = ${9:undefined}$0" "guarded function"
                        (=
                         (length "fn")
                         (current-column))
                        nil
                        ((yas-indent-line 'fixed))
                        nil nil nil)
                       ("<-" "${1:x} <- ${2:undefined}$0" "monadic get" nil nil nil nil nil nil)
                       ("if" "if ${1:condition}\n    then ${2:undefined}\n    else ${3:undefined}$0" "block if" nil nil nil nil nil nil)
                       ("if" "if ${1:condition} then ${2:undefined} else ${3:undefined}$0" "inline if" nil nil nil nil nil nil)
